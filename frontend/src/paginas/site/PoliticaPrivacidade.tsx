  ...
  return (
    <div className="site">
      ...
      <section className="pagina-texto">
        ...
        <p>Política de Privacidade do site www.zaieze.com</p>

        <p>
          A sua privacidade é importante para nós. É política da Zaieze respeitar a sua privacidade em relação a
          qualquer informação sua que possamos coletar no site www.zaieze.com, e outros sites que possuímos e
          operamos.
        </p>
        <p>
        ...
        <p>
          ...
          e informações pessoais, entre em contato conosco pelo e-mail <a href="mailto:sac@zaieze.com">sac@zaieze.com</a>.
        </p>

        <h2>Política de Cookies Zaieze</h2>
        ...
        <p>
          ...
          existem opções padrão do setor para desativar os cookies sem desativar completamente a funcionalidade e
        ...
        <ul>
          ...
          <li><strong>Cookies relacionados a comércio eletrônico.</strong> Este site oferece facilidades de comércio eletrônico ou pagamento e alguns cookies são essenciais para garantir que seu pedido seja lembrado entre as páginas, para que possamos processá-lo adequadamente.</li>
        ...
        <ul>
          ...
          <li>Periodicamente, testamos novos recursos e fazemos alterações na maneira como o site se apresenta. Quando ainda estamos testando novos recursos, esses cookies podem ser usados para garantir que você receba uma experiência consistente enquanto estiver no site, enquanto entendemos quais otimizações os nossos usuários mais apreciam.</li>
        ...
        <p>
          O usuário se compromete a fazer uso adequado dos conteúdos e da informação que a Zaieze oferece no site
        ...
        <ul>
          ...
          <li>Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, política, qualquer tipo de pornografia legal ou ilegal, apologia ao terrorismo ou contra os direitos humanos;</li>
          <li>Não causar danos aos sistemas físicos (hardwares) e programas (softwares) da Zaieze, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus, malware, spam etc., ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar os danos anteriormente mencionados.</li>
        </ul>
        ...
        <div className="pagina-texto-lema">
          <span>Esta política é efetiva a partir de maio/2026.</span>
        </div>
      </section>
